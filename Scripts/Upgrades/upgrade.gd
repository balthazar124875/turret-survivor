...
var upgradeAmount = 0;
@export var maxAmount = 100
@export var isLocked = false; #Set this to true to make this item locked, to unlock it you'll have to fullfill an UnlockNode condition.
