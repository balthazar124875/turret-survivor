...
static var WEAPON_VARIATION_TYPE_SWAPS = [
	WEAPON_VARIATION.BLAZING,
	WEAPON_VARIATION.SHOCKING,
	WEAPON_VARIATION.SHIVERING,
	WEAPON_VARIATION.MYSTIC,
	WEAPON_VARIATION.TOXIC
]
